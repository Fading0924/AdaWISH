...
f.write("cd $TMPDIR\n")
f.write("export PATH=/home/fs01/yx247/anaconda3/bin/:$PATH\n")
f.write("ParaFly -c %s_script.txt -CPU %s -failed_cmds %s_rerun.txt\n" % (fname, str(24),fname))
f.write("cp %s_rerun.txt %s/" % (fname, outputdir))
f.close()
