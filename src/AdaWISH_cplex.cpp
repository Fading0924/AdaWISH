...
int main(int argc, char **argv)
{
  ...
  try {
    ...
    else if (scopes[l].size() == 3)
    {
        ...
        char *name = new char[32];
        sprintf(name, "mu_%d_%d_%d (0,0,0)", (int) i, (int) j, (int) k);
        IloBoolVar mu_i_j_k_0_0_0 (env, 0, 1, name);					// (18)
        model.add(mu_i_j_k_0_0_0);
        
        sprintf(name, "mu_%d_%d_%d (0,0,1)", (int) i, (int) j, (int) k);
        IloBoolVar mu_i_j_k_0_0_1 (env, 0, 1, name);					// (18)
        model.add(mu_i_j_k_0_0_1);

        sprintf(name, "mu_%d_%d_%d (0,1,0)", (int) i, (int) j, (int) k);
        IloBoolVar mu_i_j_k_0_1_0 (env, 0, 1, name);					// (18)
        model.add(mu_i_j_k_0_1_0);

        sprintf(name, "mu_%d_%d_%d (0,1,1)", (int) i, (int) j, (int) k);
        IloBoolVar mu_i_j_k_0_1_1 (env, 0, 1, name);					// (18)
        model.add(mu_i_j_k_0_1_1);

        sprintf(name, "mu_%d_%d_%d (1,0,0)", (int) i, (int) j, (int) k);
        IloBoolVar mu_i_j_k_1_0_0 (env, 0, 1, name);					// (18)
        model.add(mu_i_j_k_1_0_0);

        sprintf(name, "mu_%d_%d_%d (1,0,1)", (int) i, (int) j, (int) k);
        IloBoolVar mu_i_j_k_1_0_1 (env, 0, 1, name);					// (18)
        model.add(mu_i_j_k_1_0_1);

        sprintf(name, "mu_%d_%d_%d (1,1,0)", (int) i, (int) j, (int) k);
        IloBoolVar mu_i_j_k_1_1_0 (env, 0, 1, name);					// (18)
        model.add(mu_i_j_k_1_1_0);

        sprintf(name, "mu_%d_%d_%d (1,1,1)", (int) i, (int) j, (int) k);
        IloBoolVar mu_i_j_k_1_1_1 (env, 0, 1, name);					// (18)
        model.add(mu_i_j_k_1_1_1);

        model.add((mu_i_j_k_0_0_0 + mu_i_j_k_0_0_1 + mu_i_j_k_0_1_0 + mu_i_j_k_0_1_1 == 1-vars[i]));
        model.add((mu_i_j_k_1_0_0 + mu_i_j_k_1_0_1 + mu_i_j_k_1_1_0 + mu_i_j_k_1_1_1 == vars[i]));
        model.add((mu_i_j_k_0_0_0 + mu_i_j_k_0_0_1 + mu_i_j_k_1_0_0 + mu_i_j_k_1_0_1 == 1-vars[j]));
        model.add((mu_i_j_k_0_1_0 + mu_i_j_k_0_1_1 + mu_i_j_k_1_1_0 + mu_i_j_k_1_1_1 == vars[j]));
        model.add((mu_i_j_k_0_0_0 + mu_i_j_k_0_1_0 + mu_i_j_k_1_0_0 + mu_i_j_k_1_1_0 == 1-vars[k]));
        model.add((mu_i_j_k_0_0_1 + mu_i_j_k_0_1_1 + mu_i_j_k_1_0_1 + mu_i_j_k_1_1_1 == vars[k]));

        model.add((mu_i_j_k_0_0_0 + mu_i_j_k_0_0_1 + mu_i_j_k_0_1_0 + mu_i_j_k_0_1_1 <= 1));
        model.add((mu_i_j_k_1_0_0 + mu_i_j_k_1_0_1 + mu_i_j_k_1_1_0 + mu_i_j_k_1_1_1 <= 1));
        model.add((mu_i_j_k_0_0_0 + mu_i_j_k_0_0_1 + mu_i_j_k_1_0_0 + mu_i_j_k_1_0_1 <= 1));
        model.add((mu_i_j_k_0_1_0 + mu_i_j_k_0_1_1 + mu_i_j_k_1_1_0 + mu_i_j_k_1_1_1 <= 1));
        model.add((mu_i_j_k_0_0_0 + mu_i_j_k_0_1_0 + mu_i_j_k_1_0_0 + mu_i_j_k_1_1_0 <= 1));
        model.add((mu_i_j_k_0_0_1 + mu_i_j_k_0_1_1 + mu_i_j_k_1_0_1 + mu_i_j_k_1_1_1 <= 1));
        
        
        if (isfinite(cost[l][0]))
            objexpr += cost[l][0]* mu_i_j_k_0_0_0;
        else
        {
        if (isinf(cost[l][0]))
            {
            model.add(mu_i_j_k_0_0_0==0);
            }
        else
            {
            cout << "Cannot generate ILP"<< endl;
        ...
        if (isfinite(cost[l][1]))
            objexpr += cost[l][1]* mu_i_j_k_0_0_1;
        else
        {
        if (isinf(cost[l][1]))
            {
            model.add(mu_i_j_k_0_0_1==0);
            }
        else
            {
            cout << "Cannot generate ILP"<< endl;
        ...
        if (isfinite(cost[l][2]))
            objexpr +=cost[l][2]* mu_i_j_k_0_1_0;
        else
        {
        if (isinf(cost[l][2]))
            {
            model.add(mu_i_j_k_0_1_0==0);
            }
        else
            {
            cout << "Cannot generate ILP"<< endl;
        ...
        if (isfinite(cost[l][3]))
            objexpr += cost[l][3]* mu_i_j_k_0_1_1;	
        else
        {
        if (isinf(cost[l][3]))
            {
        ...
        if (isfinite(cost[l][4]))
            objexpr += cost[l][4]* mu_i_j_k_1_0_0;
        else
        {
        if (isinf(cost[l][4]))
            {
            model.add(mu_i_j_k_1_0_0==0);
            }
        else
            {
            cout << "Cannot generate ILP"<< endl;
        ...
        if (isfinite(cost[l][5]))
            objexpr += cost[l][5]* mu_i_j_k_1_0_1;
        else
        {
        if (isinf(cost[l][5]))
            {
            model.add(mu_i_j_k_1_0_1==0);
            }
        else
            {
            cout << "Cannot generate ILP"<< endl;
        ...
        if (isfinite(cost[l][6]))
            objexpr +=cost[l][6]* mu_i_j_k_1_1_0;
        else
        {
        if (isinf(cost[l][6]))
            {
            model.add(mu_i_j_k_1_1_0==0);
            }
        else
            {
            cout << "Cannot generate ILP"<< endl;
        ...
        if (isfinite(cost[l][7]))
            objexpr += cost[l][7]* mu_i_j_k_1_1_1;	
        else
        {
        if (isinf(cost[l][7]))
            {
...
//cout << objexpr;
    ...
    // env.out() << "Solution value log10lik = " << cplex.getBestObjValue() << endl;
